                                          ...
                                          const FGameplayEventData* TriggerEventData)
{
	...
	if (UAureAbilitySystemComponent* AuraASC = Cast<UAureAbilitySystemComponent>(UAbilitySystemBlueprintLibrary::GetAbilitySystemComponent(GetAvatarActorFromActorInfo())))
	{
