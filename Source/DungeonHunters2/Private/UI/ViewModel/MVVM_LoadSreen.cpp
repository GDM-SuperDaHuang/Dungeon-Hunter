...
void UMVVM_LoadSreen::InitializeLoadSlots()
{
...
UMVVM_LoadSlot* UMVVM_LoadSreen::GetLoadSlotViewModelByIndex(int32 Index) const
{
	return LoadSlots.FindChecked(Index);
}

void UMVVM_LoadSreen::NewSlotButtonPressed(int32 Slot, const FString& EnteredName)
{
...
void UMVVM_LoadSreen::NewGameButtonPressed(int32 Slot)
{
	LoadSlots[Slot]->SetWidgetSwitcherIndex.Broadcast(1);
}

void UMVVM_LoadSreen::SelectSlotButtonPressed(int32 Slot)
{
...
void UMVVM_LoadSreen::DeleteButtonPressed()
{
...
void UMVVM_LoadSreen::PlayButtonPressed()
{
	// AAuraGameModeBase* AuraGameMode = Cast<AAuraGameModeBase>(UGameplayStatics::GetGameMode(this));
	// UAuraGameInstance* AuraGameInstance = Cast<UAuraGameInstance>(AuraGameMode->GetGameInstance());
...
void UMVVM_LoadSreen::SetNumLoadSlots(int32 InNumLoadSlots)
{
